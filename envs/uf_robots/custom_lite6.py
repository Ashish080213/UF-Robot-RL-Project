...
# Get the directory of the current file (custom_lite6.py)
...
class Lite6(PyBulletRobot):
    """Lite6 robot in PyBullet.
    ...
    def __init__(
        ...
        super().__init__(
            sim,
            body_name="lite6" if not self.block_gripper else "lite6",
            # file_name= urdf_file_dir + ("/lite6.urdf" if not self.block_gripper else "/lite6.urdf"),
            file_name= urdf_path,
    ...
    def ee_displacement_to_target_arm_angles(self, ee_displacement: np.ndarray) -> np.ndarray:
        ...
        """
        ee_displacement = ee_displacement[:3] * 0.025  # limit maximum change in position
